    ...
    <div style="background-color: lightgray; margin-left: 35%; margin-top: 7%; width: 30%; position: absolute;" class="img-rounded">
        <form runat="server" class="form" style="width: 80%; height: 80%; margin: auto;">
            <div class="form-group">
                ...
                <small id="smWrong" runat="server" style="color: red; text-align:center;" class="form-text text-muted text-danger col-sm-12" ></small>
            </div>
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="ddlGenre" ClientIDMode="Static" runat="server" CssClass="form-control">
                    <asp:ListItem Value="default" Text="-Select Genre" Selected="True"></asp:ListItem>
                </asp:DropDownList>
            ...
            <div style="text-align: center;">
                <asp:Button ID="btnBecome" runat="server" ClientIDMode="Static" CssClass="btn btn-primary btn-lg" style="background-color: maroon;" Text="Start Grooving!" OnClick="btnBecome_Click" />
            </div>
        </form>
    </div>
</asp:Content>
