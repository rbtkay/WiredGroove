        ...
        $.each(mediaList.d, function () {
            ...
            <div class="col-sm-12">
                <div class="media">
                    <a class=pull-left href="#">
                        <img class="media-object dp " src="`+ this.media + `" style="width: auto; height: 300px;">
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading">` + this.email + `<small> ` + this.name + `<small></h4>
                        <h5>Starting Date:<p></p>
                        </h5>
            ...
            <div class="col-sm-12">
                <div class="media">
                    <a class=pull-left href="#">
                    <audio controls>
                        <source class="media-object dp" src="`+ this.media + `type="audio/ogg">
                        <source class="media-object dp" src="`+ this.media + `type="audio/mpeg">
                    </audio>
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading">` + this.email + `<small> ` + this.name + `<small></h4>
